...
Report bugs at [https://github.com/alanmehio/rf-analysis-engine/issues](https://github.com/alanmehio/rf-analysis-engine/issues).

Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/alanmehio/rf-analysis-engine/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
The best way to send feedback is to file an issue at [https://github.com/alanmehio/rf-analysis-engine/issues](https://github.com/alanmehio/rf-analysis-engine/issues).
...
The roadmap(issues) located [here](https://github.com/alanmehio/rf-analysis-engine/issues)
